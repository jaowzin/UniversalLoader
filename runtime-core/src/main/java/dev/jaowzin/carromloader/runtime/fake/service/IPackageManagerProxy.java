...
import dev.jaowzin.carromloader.mirror.android.app.ContextImpl;
import dev.jaowzin.carromloader.mirror.android.content.pm.BRPackageManager;
...
import dev.jaowzin.carromloader.runtime.fake.FakeCore;
...
public class IPackageManagerProxy extends BinderInvocationStub {
    ...
    protected void inject(Object baseInvocation, Object proxyInvocation) {
        ...
        Object systemContext = BRActivityThread.get(CarromRuntimeCore.mainThread()).getSystemContext();
    ...
    public static class ResolveIntent extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            ResolveInfo resolveInfo = CarromRuntimeCore.getBPackageManager().resolveIntent(intent, resolvedType, flags, CarromRuntimeCore.getUserId());
            if (resolveInfo != null) {
                return resolveInfo;
            }
    ...
    public static class ResolveService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            String resolvedType = (String) args[1];
            int flags = MethodParameterUtils.toInt(args[2]);
            ResolveInfo resolveInfo = CarromRuntimeCore.getBPackageManager().resolveService(intent, flags, resolvedType, CarromRuntimeCore.getUserId());
            if (resolveInfo != null) {
                return resolveInfo;
            }
            return method.invoke(who, args);
    ...
    public static class GetPackageInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            PackageInfo packageInfo = CarromRuntimeCore.getBPackageManager().getPackageInfo(packageName, flags, CarromRuntimeCore.getUserId());
            if (packageInfo != null) {
    ...
    public static class GetProviderInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            int flags = MethodParameterUtils.toInt(args[1]);
            ProviderInfo providerInfo = CarromRuntimeCore.getBPackageManager().getProviderInfo(componentName, flags, CarromRuntimeCore.getUserId());
    ...
    public static class GetReceiverInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ComponentName componentName = (ComponentName) args[0];
            int flags = MethodParameterUtils.toInt(args[1]);
            ActivityInfo receiverInfo = CarromRuntimeCore.getBPackageManager().getReceiverInfo(componentName, flags, CarromRuntimeCore.getUserId());
    ...
    public static class GetActivityInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ComponentName componentName = (ComponentName) args[0];
            int flags = MethodParameterUtils.toInt(args[1]);
            ActivityInfo activityInfo = CarromRuntimeCore.getBPackageManager().getActivityInfo(componentName, flags, CarromRuntimeCore.getUserId());
    ...
    public static class GetServiceInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ComponentName componentName = (ComponentName) args[0];
            int flags = MethodParameterUtils.toInt(args[1]);
            ServiceInfo serviceInfo = CarromRuntimeCore.getBPackageManager().getServiceInfo(componentName, flags, CarromRuntimeCore.getUserId());
            if (serviceInfo != null)
                return serviceInfo;
            if (AppSystemEnv.isOpenPackage(componentName)) {
                return method.invoke(who, args);
    ...
    public static class GetInstalledApplications extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            List<ApplicationInfo> installedApplications = CarromRuntimeCore.getBPackageManager().getInstalledApplications(flags, CarromRuntimeCore.getUserId());
    ...
    public static class GetInstalledPackages extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            int flags = MethodParameterUtils.toInt(args[0]);
            List<PackageInfo> installedPackages = CarromRuntimeCore.getBPackageManager().getInstalledPackages(flags, CarromRuntimeCore.getUserId());
    ...
    public static class GetApplicationInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            ApplicationInfo applicationInfo = CarromRuntimeCore.getBPackageManager().getApplicationInfo(packageName, flags, CarromRuntimeCore.getUserId());
    ...
    public static class QueryContentProviders extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            int flags = MethodParameterUtils.toInt(args[2]);
            List<ProviderInfo> providers = CarromRuntimeCore.getBPackageManager().
                    queryContentProviders(CarromRuntimeCore.getAppProcessName(), CarromRuntimeCore.getBUid(), flags, CarromRuntimeCore.getUserId());
    ...
    public static class QueryBroadcastReceivers extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            List<ResolveInfo> resolves = CarromRuntimeCore.getBPackageManager().queryBroadcastReceivers(intent, flags, type, BActivityThread.getUserId());
    ...
    public static class ResolveContentProvider extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            int flags = MethodParameterUtils.toInt(args[1]);
            ProviderInfo providerInfo = CarromRuntimeCore.getBPackageManager().resolveContentProvider(authority, flags, BActivityThread.getUserId());
            if (providerInfo == null) {
                return method.invoke(who, args);
            }
            return providerInfo;
    ...
    public static class GetPackagesForUid extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (uid == CarromRuntimeCore.getHostUid()) {
                args[0] = BActivityThread.getBUid();
                uid = (int) args[0];
            }
            String[] packagesForUid = CarromRuntimeCore.getBPackageManager().getPackagesForUid(uid);
    ...
    public static class getComponentEnabledSetting extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            ApplicationInfo applicationInfo = CarromRuntimeCore.getBPackageManager().getApplicationInfo(packageName,0, BActivityThread.getUserId());
