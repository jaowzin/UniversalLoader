package dev.jaowzin.carromloader.runtime.utils.provider;
...
import dev.jaowzin.carromloader.runtime.utils.compat.ContentProviderCompat;


public class ProviderCall {
    public static Bundle callSafely(String authority, String methodName, String arg, Bundle bundle) {
        try {
            return call(authority, CarromRuntimeCore.getContext(), methodName, arg, bundle, 5);
