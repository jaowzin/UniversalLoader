        ...
        try {
            ...
            for (String fieldName : uidFieldNames) {
                try {
                    ...
                    uidField.set(attributionSource, CarromRuntimeCore.getHostUid());
            ...
            try {
                ...
                setUidMethod.invoke(attributionSource, CarromRuntimeCore.getHostUid());
            ...
            for (String fieldName : packageFieldNames) {
                try {
                    ...
                    packageField.set(attributionSource, CarromRuntimeCore.getHostPkg());
    ...
    public static Object createSafeAttributionSource() {
        try {
            ...
            try {
                ...
                attributionSource = constructor.newInstance(CarromRuntimeCore.getHostUid(), CarromRuntimeCore.getHostPkg());
            } catch (Exception e) {
                try {
