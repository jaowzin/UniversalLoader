package dev.jaowzin.carromloader.runtime.entity.pm;
...
public class InstalledPackage implements Parcelable {
    ...
    public ApplicationInfo getApplication() {
        return CarromRuntimeCore.getBPackageManager().getApplicationInfo(packageName, PackageManager.GET_META_DATA, userId);
    }

    public PackageInfo getPackageInfo() {
        return CarromRuntimeCore.getBPackageManager().getPackageInfo(packageName, PackageManager.GET_META_DATA, userId);
    }
