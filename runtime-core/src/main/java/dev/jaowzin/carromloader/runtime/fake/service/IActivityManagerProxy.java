...
import dev.jaowzin.carromloader.mirror.android.app.BRActivityManagerOreo;
import dev.jaowzin.carromloader.mirror.android.app.BRLoadedApkReceiverDispatcher;
import dev.jaowzin.carromloader.mirror.android.app.BRLoadedApkReceiverDispatcherInnerReceiver;
import dev.jaowzin.carromloader.mirror.android.app.BRLoadedApkServiceDispatcher;
import dev.jaowzin.carromloader.mirror.android.app.BRLoadedApkServiceDispatcherInnerConnection;
import dev.jaowzin.carromloader.mirror.android.content.BRContentProviderNative;
...
import dev.jaowzin.carromloader.runtime.entity.am.RunningAppProcessInfo;
import dev.jaowzin.carromloader.runtime.entity.am.RunningServiceInfo;
import dev.jaowzin.carromloader.runtime.fake.delegate.ContentProviderDelegate;
import dev.jaowzin.carromloader.runtime.fake.delegate.InnerReceiverDelegate;
import dev.jaowzin.carromloader.runtime.fake.delegate.ServiceConnectionDelegate;
...
import dev.jaowzin.carromloader.runtime.proxy.record.ProxyPendingRecord;
...
import dev.jaowzin.carromloader.runtime.utils.compat.ParceledListSliceCompat;
...
public class IActivityManagerProxy extends ClassInvocationStub {
    ...
    public static class GetContentProvider extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (auth instanceof String) {
                ...
                if (BuildCompat.isQ()) {
                    args[1] = CarromRuntimeCore.getHostPkg();
                }
                ...
                if (auth.equals("settings")
                    ...
                    ProviderInfo providerInfo = CarromRuntimeCore.getBPackageManager()
    ...
    public static class StartService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            ResolveInfo resolveInfo = CarromRuntimeCore.getBPackageManager().resolveService(intent, 0, resolvedType, BActivityThread.getUserId());
            if (resolveInfo == null) {
                return method.invoke(who, args);
            }
            ...
            return CarromRuntimeCore.getBActivityManager().startService(intent, resolvedType, requireForeground, BActivityThread.getUserId());
        }
    ...
    public static class StopService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                return CarromRuntimeCore.getBActivityManager().stopService(intent, resolvedType, BActivityThread.getUserId());
            } catch (SecurityException e) {
    ...
    public static class StopServiceToken extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                CarromRuntimeCore.getBActivityManager().stopServiceToken(componentName, token, BActivityThread.getUserId());
                return true;
            } catch (SecurityException e) {
    ...
    public static Object BindServiceCommon(Object who, Method method, Object[] args,int callingPackageIndex) throws Throwable {
        try {
            ...
            ResolveInfo resolveInfo = CarromRuntimeCore.getBPackageManager().resolveService(intent, 0, resolvedType, userId);
            if (resolveInfo != null || AppSystemEnv.isOpenPackage(intent.getComponent())) {
                Intent proxyIntent = CarromRuntimeCore.getBActivityManager().bindService(intent,
                ...
                if (proxyIntent != null && proxyIntent.getComponent() != null && 
                    proxyIntent.getComponent().getPackageName().equals(CarromRuntimeCore.getHostPkg())){
                ...
                args[callingPackageIndex] = CarromRuntimeCore.getHostPkg();
    ...
    public static class BindService extends MethodHook {
        ...
        protected boolean isEnable() {
            return CarromRuntimeCore.get().isBlackProcess() || CarromRuntimeCore.get().isServerProcess();
        }
    }
    ...
    public static class UnbindService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            CarromRuntimeCore.getBActivityManager().unbindService(iServiceConnection.asBinder(), BActivityThread.getUserId());
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            for (int i = 0; i < intents.length; i++) {
                ...
                switch (type) {
                    case ActivityManagerCompat.INTENT_SENDER_ACTIVITY:
                        ...
                        shadow.setComponent(new ComponentName(CarromRuntimeCore.getHostPkg(), ProxyManifest.getProxyPendingActivity(BActivityThread.getAppPid())));
            ...
            if (invoke != null) {
                ...
                if (packagesForUid.length < 1) {
                    packagesForUid = new String[]{CarromRuntimeCore.getHostPkg()};
                }
                CarromRuntimeCore.getBActivityManager().getIntentSender(invoke.asBinder(), packagesForUid[0], BActivityThread.getCallingBUid());
            }
            return invoke;
        }
    ...
    public static class getPackageForIntentSender extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            return CarromRuntimeCore.getBActivityManager().getPackageForIntentSender(invoke.asBinder());
        }
    }
    ...
    public static class getUidForIntentSender extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            IInterface invoke = (IInterface) args[0];
            return CarromRuntimeCore.getBActivityManager().getUidForIntentSender(invoke.asBinder());
        }
    }
    ...
    public static class BroadcastIntent extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            Intent proxyIntent = CarromRuntimeCore.getBActivityManager().sendBroadcast(intent, resolvedType, BActivityThread.getUserId());
            if (proxyIntent != null) {
    ...
    public static class PeekService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            IBinder peek = CarromRuntimeCore.getBActivityManager().peekService(intent, resolvedType, BActivityThread.getUserId());
            return peek;
        }
    }
