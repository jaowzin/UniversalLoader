    ...
    public static class AttributionSourceConstructor extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                int uid = CarromRuntimeCore.getHostUid();
                String packageName = CarromRuntimeCore.getHostPkg();
                ...
                return createSafeAttributionSource(CarromRuntimeCore.getHostUid(), CarromRuntimeCore.getHostPkg());
            }
        }
    ...
    public static class FromParcel extends MethodHook {
        ...
        private void fixAttributionSourceUid(Object attributionSource) {
            try {
                ...
                Slog.d(TAG, "Fixed AttributionSource UID to: " + CarromRuntimeCore.getHostUid());
            } catch (Exception e) {
