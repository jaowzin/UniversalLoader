        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            try {
                if (args != null && args.length > 0 && args[0] instanceof Context) {
                    ...
                    context = CarromRuntimeCore.getContext();
                }
        ...
        private void configureWebView(WebView webView) {
            try {
                ...
                if (settings != null) {
                    ...
                    if (userAgent != null && !userAgent.contains("CarromRuntime")) {
                        settings.setUserAgentString(userAgent + " CarromRuntime");
                    }
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                if (args != null && args.length > 0) {
                    ...
                    Context context = CarromRuntimeCore.getContext();
    ...
    public static class GetDataDirectory extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                return "/data/data/" + CarromRuntimeCore.getHostPkg() + "/webview_fallback";
            }
        }
    }
