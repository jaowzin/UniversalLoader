...
import dev.jaowzin.carromloader.mirror.android.app.job.BRJobInfo;
...
public class BJobManagerService extends IBJobManagerService.Stub implements ISystemService {
    ...
    public JobInfo scheduleJob(ProcessRecord processRecord, JobInfo info, ServiceInfo serviceInfo) {
        ...
        BRJobInfo.get(info)._set_service(new ComponentName(CarromRuntimeCore.getHostPkg(), ProxyManifest.getProxyJobService(processRecord.bpid)));
        return info;
    }
