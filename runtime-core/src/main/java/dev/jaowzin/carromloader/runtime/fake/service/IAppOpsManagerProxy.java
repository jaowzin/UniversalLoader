...
import dev.jaowzin.carromloader.mirror.android.app.BRAppOpsManager;
import dev.jaowzin.carromloader.mirror.android.os.BRServiceManager;
import dev.jaowzin.carromloader.mirror.com.android.internal.app.BRIAppOpsServiceStub;
...
public class IAppOpsManagerProxy extends BinderInvocationStub {
    ...
    protected void inject(Object baseInvocation, Object proxyInvocation) {
        if (BRAppOpsManager.get(null)._check_mService() != null) {
            AppOpsManager appOpsManager = (AppOpsManager) CarromRuntimeCore.getContext().getSystemService(Context.APP_OPS_SERVICE);
            try {
