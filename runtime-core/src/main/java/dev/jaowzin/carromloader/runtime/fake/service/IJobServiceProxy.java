...
import dev.jaowzin.carromloader.mirror.android.app.job.BRIJobSchedulerStub;
...
import dev.jaowzin.carromloader.runtime.utils.UIDSpoofingHelper;
...
public class IJobServiceProxy extends BinderInvocationStub {
    ...
    public static class Schedule extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                try {
                    JobInfo proxyJobInfo = CarromRuntimeCore.getBJobManager().schedule(jobInfo);
                    ...
                    Slog.w(TAG, "Schedule: CarromRuntime job manager failed, trying system fallback", e);
                }
    ...
    public static class Cancel extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                args[0] = CarromRuntimeCore.getBJobManager()
    ...
    public static class CancelAll extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                CarromRuntimeCore.getBJobManager().cancelAll(BActivityThread.getAppConfig().processName);
                return method.invoke(who, args);
            } catch (Exception e) {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                try {
                    ...
                    Slog.w(TAG, "Enqueue: CarromRuntime job manager failed, trying system fallback", e);
                }
