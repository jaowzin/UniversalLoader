...
import dev.jaowzin.carromloader.runtime.utils.compat.DexFileCompat;
...
public class NativeCore {
    ...
    static {
        ...
        System.loadLibrary("universalruntime");
    }
    ...
    public static int getCallingUid(int origCallingUid) {
        try {
            ...
            if (origCallingUid == CarromRuntimeCore.getHostUid()) {
                
                String appPackageName = CarromRuntimeCore.getAppPackageName();
                ...
                try {
                    int callingBUid = CarromRuntimeCore.getCallingBUid();
                ...
                return CarromRuntimeCore.getHostUid();
            }
            return origCallingUid;
        } catch (Exception e) {
