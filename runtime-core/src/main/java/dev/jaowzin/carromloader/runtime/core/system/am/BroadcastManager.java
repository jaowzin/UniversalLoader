...
import dev.jaowzin.carromloader.runtime.core.system.pm.BPackage;
...
import dev.jaowzin.carromloader.runtime.proxy.ProxyBroadcastReceiver;
            ...
            for (BPackage.Activity receiver : bPackage.receivers) {
                ...
                for (BPackage.ActivityIntentInfo intent : intents) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                        CarromRuntimeCore.getContext().registerReceiver(proxyBroadcastReceiver, intent.intentFilter, Context.RECEIVER_EXPORTED);
                    }else{
                        CarromRuntimeCore.getContext().registerReceiver(proxyBroadcastReceiver, intent.intentFilter);
                    }
            ...
            synchronized (mReceivers) {
                ...
                if (broadcastReceivers != null) {
                    ...
                    for (BroadcastReceiver broadcastReceiver : broadcastReceivers) {
                        try {
                            CarromRuntimeCore.getContext().unregisterReceiver(broadcastReceiver);
