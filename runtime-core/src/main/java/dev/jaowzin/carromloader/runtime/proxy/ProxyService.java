...
public class ProxyService extends Service {
    ...
    private void showNotification() {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext(), getPackageName() + ".carromruntime_proxy")
                .setPriority(NotificationCompat.PRIORITY_MAX);
        if (BuildCompat.isOreo()) {
            startForeground(CarromRuntimeCore.getHostPkg().hashCode(), builder.build());
        }
    }
