...
public class DaemonService extends Service {
    ...
    private static final int NOTIFY_ID = CarromRuntimeCore.getHostPkg().hashCode();
    private static final String CHANNEL_ID = "carromruntime_daemon_channel";
    private static final String CHANNEL_NAME = "CarromRuntime Daemon Service";
    private static final String CHANNEL_DESCRIPTION = "Keeps CarromRuntime core services running";
    ...
    private Notification createNotification() {
        try {
            NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_ID)
                .setContentTitle("CarromRuntime Core")
