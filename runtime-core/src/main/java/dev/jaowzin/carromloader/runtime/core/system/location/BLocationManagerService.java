package dev.jaowzin.carromloader.runtime.core.system.location;
...
import dev.jaowzin.carromloader.mirror.android.location.BRILocationListener;
import dev.jaowzin.carromloader.mirror.android.location.BRILocationListenerStub;
...
import dev.jaowzin.carromloader.runtime.entity.location.BCell;
import dev.jaowzin.carromloader.runtime.entity.location.BLocation;
import dev.jaowzin.carromloader.runtime.entity.location.BLocationConfig;
import dev.jaowzin.carromloader.runtime.fake.frameworks.BLocationManager;
import dev.jaowzin.carromloader.runtime.utils.CloseUtils;
    ...
    private void addTask(IBinder locationListener) {
        mThreadPool.execute(() -> {
            ...
            while (locationListener.pingBinder()) {
                ...
                CarromRuntimeCore.get().getHandler().post(() -> BRILocationListener.get(iInterface).onLocationChanged(location.convert2SystemLocation()));
            }
        });
    }
