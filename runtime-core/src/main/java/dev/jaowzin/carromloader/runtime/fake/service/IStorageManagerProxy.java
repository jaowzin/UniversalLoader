...
import dev.jaowzin.carromloader.mirror.android.os.mount.BRIMountServiceStub;
import dev.jaowzin.carromloader.mirror.android.os.storage.BRIStorageManagerStub;
...
public class IStorageManagerProxy extends BinderInvocationStub {
    ...
    public static class GetVolumeList extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            if (args == null) {
                StorageVolume[] volumeList = CarromRuntimeCore.getBStorageManager().getVolumeList(BActivityThread.getBUid(), null, 0, BActivityThread.getUserId());
                if (volumeList == null) {
            ...
            try {
                ...
                StorageVolume[] volumeList = CarromRuntimeCore.getBStorageManager().getVolumeList(uid, packageName, flags, BActivityThread.getUserId());
                if (volumeList == null) {
                    return method.invoke(who, args);
                }
                return volumeList;
