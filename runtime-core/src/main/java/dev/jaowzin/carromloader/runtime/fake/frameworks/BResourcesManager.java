...
public class BResourcesManager implements IInjectHook {
    ...
    private static Object getPackageManager() {
        try {
            Class<?> carromRuntimeCoreClass = Class.forName("dev.jaowzin.carromloader.runtime.CarromRuntimeCore");
            Method getPackageManagerMethod = carromRuntimeCoreClass.getMethod("getPackageManager");
