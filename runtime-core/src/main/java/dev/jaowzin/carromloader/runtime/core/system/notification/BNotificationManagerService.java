package dev.jaowzin.carromloader.runtime.core.system.notification;
...
import dev.jaowzin.carromloader.mirror.android.app.BRNotificationChannel;
import dev.jaowzin.carromloader.mirror.android.app.BRNotificationChannelGroup;
import dev.jaowzin.carromloader.mirror.android.app.BRNotificationO;
import dev.jaowzin.carromloader.mirror.android.app.NotificationChannelContext;
import dev.jaowzin.carromloader.mirror.android.app.NotificationChannelGroupContext;
import dev.jaowzin.carromloader.mirror.android.app.NotificationOContext;
...
public class BNotificationManagerService extends IBNotificationManagerService.Stub implements ISystemService {
    ...
    private final NotificationManager mRealNotificationManager =
            (NotificationManager) CarromRuntimeCore.getContext().getSystemService(Context.NOTIFICATION_SERVICE);
