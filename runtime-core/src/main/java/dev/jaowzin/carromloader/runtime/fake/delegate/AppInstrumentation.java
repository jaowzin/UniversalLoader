...
import dev.jaowzin.carromloader.runtime.utils.HackAppUtils;
import dev.jaowzin.carromloader.runtime.utils.compat.ActivityCompat;
...
public final class AppInstrumentation extends BaseInstrumentationDelegate implements IInjectHook {
    ...
    public void injectHook() {
        try {
            ...
            BRActivityThread.get(CarromRuntimeCore.mainThread())._set_mInstrumentation(this);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
