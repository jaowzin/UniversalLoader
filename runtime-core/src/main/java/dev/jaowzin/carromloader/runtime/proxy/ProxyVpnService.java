...
public class ProxyVpnService extends VpnService {
    ...
    private static final String CHANNEL_ID = "CarromRuntimeVPN";
    ...
    private void createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel(
                CHANNEL_ID,
                "CarromRuntime VPN Service",
                NotificationManager.IMPORTANCE_LOW
            );
            channel.setDescription("VPN service for CarromRuntime network access");
    ...
    private Notification createNotification() {
        ...
        return builder
            .setContentTitle("CarromRuntime VPN Active")
    ...
    protected void establishVpn() {
        ...
        try {
            ...
            builder.setSession("CarromRuntime VPN");
            ...
            builder.setSession("CarromRuntime Internet Access");
