package dev.jaowzin.carromloader.runtime.core.env;
...
public class BEnvironment {
    private static final File sVirtualRoot = new File(CarromRuntimeCore.getContext().getCacheDir().getParent(), "carromruntime");
    private static final File sExternalVirtualRoot = CarromRuntimeCore.getContext().getExternalFilesDir("carromruntime");
    ...
    public static File getXSharedPreferences(String packageName, String prefFileName) {
       return new File(BEnvironment.getDataDir(packageName, CarromRuntimeCore.getUserId()), "shared_prefs/" + prefFileName + ".xml");
    }
}
