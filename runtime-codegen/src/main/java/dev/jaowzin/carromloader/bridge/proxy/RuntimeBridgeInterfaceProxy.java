package dev.jaowzin.carromloader.bridge.proxy;
...
import dev.jaowzin.carromloader.bridge.RuntimeBridgeInterfaceInfo;
import dev.jaowzin.carromloader.bridge.annotation.BConstructor;
import dev.jaowzin.carromloader.bridge.annotation.BConstructorNotProcess;
import dev.jaowzin.carromloader.bridge.annotation.BFieldCheckNotProcess;
import dev.jaowzin.carromloader.bridge.annotation.BFieldNotProcess;
import dev.jaowzin.carromloader.bridge.annotation.BFieldSetNotProcess;
import dev.jaowzin.carromloader.bridge.annotation.BMethodCheckNotProcess;
import dev.jaowzin.carromloader.bridge.annotation.BParamClass;
import dev.jaowzin.carromloader.bridge.annotation.BClassNameNotProcess;
import dev.jaowzin.carromloader.bridge.annotation.BParamClassName;


public class RuntimeBridgeInterfaceProxy {

    private final List<RuntimeBridgeInterfaceInfo> mReflections = new ArrayList<>();
    ...
    public RuntimeBridgeInterfaceProxy(String packageName, String className, String origClassName) {
    ...
    public JavaFile generateInterfaceCode() {
        ...
        for (RuntimeBridgeInterfaceInfo reflection : mReflections) {
    ...
    private MethodSpec generateFieldSet(RuntimeBridgeInterfaceInfo reflection) {
    ...
    private MethodSpec generateFieldCheck(RuntimeBridgeInterfaceInfo reflection) {
    ...
    private MethodSpec generateMethodCheck(RuntimeBridgeInterfaceInfo reflection, List<ParameterSpec> parameterSpecs) {
        MethodSpec.Builder method = MethodSpec.methodBuilder("_check_" + reflection.getExecutableElement().getSimpleName().toString())
                .addModifiers(Modifier.PUBLIC, Modifier.ABSTRACT)
    ...
    public void add(RuntimeBridgeInterfaceInfo interfaceInfo) {
