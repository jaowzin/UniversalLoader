...
import dev.jaowzin.carromloader.bridge.RuntimeBridgeInfo;
import dev.jaowzin.carromloader.bridge.utils.ClassUtils;


public class RuntimeBridgeProxy {

    private static final ClassName BR = ClassName.get("dev.jaowzin.carromloader.bridge", "RuntimeBridge");
    private final RuntimeBridgeInfo mReflection;

    private final ClassName mContextInterface;
    private final ClassName mStaticInterface;
    private final String mPackageName;

    public RuntimeBridgeProxy(String packageName, RuntimeBridgeInfo reflection) {
    ...
    private MethodSpec generaIsLoadMethod() {
        ...
        String statement = "return dev.jaowzin.carromloader.bridge.utils.ClassUtil.classReady($T.class)";
        builder.addStatement(statement,
                mContextInterface
        );
        return builder.build();
